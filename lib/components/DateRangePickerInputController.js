	  ...
	  _createClass(DateRangePickerInputWithHandlers, [{
	    ...
	    value: function () {
	      function onEndDateChange(endDateString) {
	        ...
	        var endDate = (0, _toMomentObject2['default'])(endDateString, this.getDisplayFormat()) || endDateString && endDateString.length === 8 ? (0, _moment2['default'])(endDateString) : null;
	    ...
	    value: function () {
	      function onStartDateChange(startDateString) {
	        var startDate = (0, _toMomentObject2['default'])(startDateString, this.getDisplayFormat()) || startDateString && startDateString.length === 8 ? (0, _moment2['default'])(startDateString) : null;
